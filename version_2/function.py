...
def scan(INTERVAL, BLE_NAME):
    ...
    devices = services.discover(INTERVAL)
...
def choose_CharUUID(address,name):
    ...
    #Discplays all service and charactertistic of the choosen BLE Device

    #initializies variable
    serviceList=[]
    charList=[]
    serviceChoice = 0
    charChoice = 0
    ...
    print("")
    print ("Discovered Services in %s: " % (name))
    print("")
    ...
    serviceChoice = int(raw_input("Choose Service: "))
